...
function getItemGroups(db: sqlite3.Database): Array<String> {
  let groups = [];
...
function getItemCategories(db: sqlite3.Database): Array<String> {
  let categories = [];
...
function getPremisesNestedLocations(db: sqlite3.Database): NestedObject {
